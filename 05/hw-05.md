...
1. Директрория **demonstration1/passwords**
...
Reference: https://github.com/terraform-linters/tflint-ruleset-terraform/blob/v0.15.0/docs/rules/terraform_required_providers.md
```

2. Директрория **demonstration1/vms**
...
Reference: https://github.com/terraform-linters/tflint-ruleset-terraform/blob/v0.15.0/docs/rules/terraform_module_pinned_source.md
...
Warning: Missing version constraint for provider "template" in `required_providers` (terraform_required_providers)
  ...
  on main.tf line 68:
  68: data "template_file" "cloudinit" {
...
3. Директрория **src/vms**

```
9 issue(s) found:

Warning: [Fixable] local.subnet_name_develop_a is declared but not used (terraform_unused_declarations)

  on locals.tf line 5:
   5:   subnet_name_develop_a = "${local.env}-${local.zone}-a"
...
Warning: [Fixable] local.subnet_name_develop_b is declared but not used (terraform_unused_declarations)

  on locals.tf line 6:
   6:   subnet_name_develop_b  = "${local.env}-${local.zone}-b"
...
Warning: Module source "git::https://github.com/udjin10/yandex_compute_instance.git?ref=main" uses a default branch as ref (main) (terraform_module_pinned_source)
  ...
  on main.tf line 34:
  34:   source         = "git::https://github.com/udjin10/yandex_compute_instance.git?ref=main"
...
Warning: [Fixable] variable "cidr_develop_a" is declared but not used (terraform_unused_declarations)

  on variables.tf line 30:
  30: variable "cidr_develop_a" {

Reference: https://github.com/terraform-linters/tflint-ruleset-terraform/blob/v0.15.0/docs/rules/terraform_unused_declarations.md

Warning: [Fixable] variable "cidr_develop_b" is declared but not used (terraform_unused_declarations)

  on variables.tf line 36:
  36: variable "cidr_develop_b" {
